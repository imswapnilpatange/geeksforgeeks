...
</span><strong style="font-size: 18px;">Explanation: </strong><span style="font-size: 18px;">From (0,0) we can find "GEEKS" horizontally right. From (0,8) we can find "GEEKS" horizontally right. From (1,0) we can find "GEEKS" horizon</span><span style="font-size: 18px;">tally right.</span><span style="font-size: 18px;"> <br/><img height="142" src="https://media.geeksforgeeks.org/img-practice/prod/addEditProblem/926518/Web/Other/blobid1_1780663080.png" width="504"/></span></span>
</pre>
<p><span style="font-size: 18px;"><strong>Constraints:</strong><br/>1 &lt;= n &lt;= m &lt;= 50<br/>1 &lt;= |word| &lt;= 20</span></p></div>