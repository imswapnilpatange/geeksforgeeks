<h2><a href="https://www.geeksforgeeks.org/problems/count-of-n-digit-numbers-whose-sum-of-digits-equals-to-given-sum0733/1">Count Of N Digit Numbers Whose Sum Of Digits Equals To Given Sum0733/1</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given two integers <strong>n</strong> and <strong>sum</strong>, determine the number of <strong>n-digit</strong> positive integers whose digits add up to sum.</span></p>
<ul>
