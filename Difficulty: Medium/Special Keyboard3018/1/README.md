<h2><a href="https://www.geeksforgeeks.org/problems/special-keyboard3018/1">Special Keyboard3018/1</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given a special keyboard that contains only four keys:</span></p>
<ul>
...
<p><span style="font-size: 18px;"><strong>Constraints:</strong><br/>1 ≤ n ≤ 70</span></p></div>