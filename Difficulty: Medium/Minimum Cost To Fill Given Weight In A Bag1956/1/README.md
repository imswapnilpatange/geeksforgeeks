...
<p><span style="font-size: 18px;"><strong>Constraints:</strong><br/>1 ≤ cost.size(), w ≤ 2*10<sup>3</sup></span><br/><span style="font-size: 18px;">1 ≤ cost[i] ≤ 10<sup>5</sup></span></p></div>