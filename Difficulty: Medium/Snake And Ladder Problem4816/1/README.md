...
So the destination is reached in 3 dice throws.<br/><img height="298" src="https://media.geeksforgeeks.org/img-practice/prod/addEditProblem/926473/Web/Other/blobid0_1781263877.webp" width="348"/><br/></span></pre>
...
<p><span style="font-size: 18px;"><strong>Constraints:</strong><br/>1 ≤ n ≤ 10<sup>3</sup><br/>1 ≤ lad.size(), sn.size(), lad[i], sn[i] ≤ n<sup>2</sup> </span></p></div>