<h2><a href="https://www.geeksforgeeks.org/problems/sorted-subsequence-of-size-3/1">Sorted Subsequence Of Size 3/1</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an array <strong>arr[]</strong>, find any subsequence of three elements such that, </span><span style="font-size: 18px;"><strong>arr[i] &lt; arr[j] &lt; arr[k]</strong> and (<strong>i &lt; j &lt; k</strong>).</span></p>
