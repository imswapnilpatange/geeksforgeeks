...
<p><span style="font-size: 18px;"><strong>Constraints:</strong><br/>1 ≤ arr.size() ≤ 10<sup>5</sup><br/>-10<sup>4</sup> ≤ arr[i] ≤ 10<sup>4<br/></sup></span><span style="font-size: 18px;">Sum of n over all test case does not exceed 10<sup>6</sup>.</span></p></div>