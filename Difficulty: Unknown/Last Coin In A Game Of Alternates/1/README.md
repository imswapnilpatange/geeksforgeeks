<h2><a href="https://www.geeksforgeeks.org/problems/last-coin-in-a-game-of-alternates/1">Last Coin In A Game Of Alternates/1</a></h2><h3>Difficulty Level : Difficulty: Unknown</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p data-pm-slice="0 0 []"><span style="font-size: 18.6667px;">Given an array integer<strong> arr[]</strong> , representing the values of coins arranged in a row.</span></p>
<ul>
...
<p><span style="font-size: 18px;"><strong>Constraints :<br/></strong></span><span style="font-size: 18px;">1 ≤ arr.size() ≤ 10<sup>5</sup><br/>1 ≤ arr[i] ≤ 10<sup>6</sup></span></p></div>