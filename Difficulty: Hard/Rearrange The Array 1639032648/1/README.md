<h2><a href="https://www.geeksforgeeks.org/problems/rearrange-the-array-1639032648/1">Rearrange The Array 1639032648/1</a></h2><h3>Difficulty Level : Difficulty: Hard</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Consider an array<strong> </strong></span><span style="font-size: 18px;"><strong>a[]</strong> = [1, 2, 3, ..., n] and a permutation <strong>b[]</strong> of size n containing all integers from 1 to n exactly once.</span></p>
<ul>
...
<p><span style="font-size: 18px;"><strong>Constraints:</strong><br/>1 <span style="font-size: 18.6667px;">≤</span> n <span style="font-size: 18.6667px;">≤</span> 10<sup>4<br/><span style="font-size: 14pt;">a.size() = b.size() = n</span><br/></sup>b[] is a permutation of integers from 1 to n.</span></p></div>