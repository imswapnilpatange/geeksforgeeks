<h2><a href="https://www.geeksforgeeks.org/problems/replace-with-xor-of-adjacent/1">Replace With Xor Of Adjacent/1</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given an array <strong>arr[]</strong> of n integers, replace each element with the <strong>XOR</strong> of its adjacent elements.</span></p>
<ul>
...
<p><span style="font-size: 18px;"><strong>Constraints:<br/></strong></span><span style="font-size: 18px;">2 ≤ n ≤ 10<sup>5</sup><br/>1 ≤ arr[i] ≤ 10<sup>7</sup></span></p></div>