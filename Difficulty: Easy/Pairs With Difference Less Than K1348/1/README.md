...
<p><span style="font-size: 18px;"><strong>Constraints:</strong><br/>1 ≤ arr.size() ≤ 10<sup>5</sup><br/>0 ≤ k ≤ 10<sup>5</sup><br/>1 ≤ arr[i] ≤ 10<sup>5</sup></span></p></div>