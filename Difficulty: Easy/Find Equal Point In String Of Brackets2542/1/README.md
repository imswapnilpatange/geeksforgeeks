...
<strong>Explanation:<br/></strong></span><img height="221" src="https://media.geeksforgeeks.org/img-practice/prod/addEditProblem/703123/Web/Other/blobid0_1781098795.webp" width="453"/> </pre>
<pre><span style="font-size: 18px;"><strong>Input :</strong> s = "))"
...
<p><span style="font-size: 18px;"><strong>Constraints:</strong><br/><span style="font-size: 14pt;">1 ≤ s.size() ≤ 10<sup>5</sup><sup><br/></sup></span></span></p></div>