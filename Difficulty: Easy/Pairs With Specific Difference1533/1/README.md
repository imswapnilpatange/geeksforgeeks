<h2><a href="https://www.geeksforgeeks.org/problems/pairs-with-specific-difference1533/1">Pairs With Specific Difference1533/1</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given an array of integers and a number k, the task is the find maximum pair sum with the following conditions on the pairs.</span></p>
<ul>
...
<p><span style="font-size: 18px;"><strong>Constraints:</strong><br/>1 ≤ arr.size() ≤ 10<sup>5</sup><br/>0 ≤ k ≤ 10<sup>5</sup><br/>1 ≤ arr[i] ≤ 10<sup>4</sup></span></p></div>